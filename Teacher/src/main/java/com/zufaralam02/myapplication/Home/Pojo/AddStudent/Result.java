...
public class Result {
    ...
    @SerializedName("Huruf_pertama")
    private String mHurufPertama;
    ...
    public String getHurufPertama() {
        return mHurufPertama;
    }

    public void setHurufPertama(String HurufPertama) {
        mHurufPertama = HurufPertama;
    }
